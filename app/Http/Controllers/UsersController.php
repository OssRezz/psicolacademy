...
class UsersController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            return redirect()->back()->with("message", "Lo sentimos, las credenciales que has proporcionado no coinciden con nuestros registros. Por favor, verifica tus datos e inténtalo de nuevo.");
        }
    }
