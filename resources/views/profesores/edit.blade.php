...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-lg-7">
            <div class="card">
                <div class="card-header fs-5"><i class="fa-solid fa-edit text-primary"></i> Editar profesor
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.profesores.update', $profesor->id) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="direccion" placeholder="direccion">{{ $profesor->direccion }}</textarea>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" placeholder="Departamento"
                                        name="departamento" value="{{ $profesor->departamento }}">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <select name="estado" class="form-select">
                                        <option value="0" {{ $profesor->estado == 0 ? 'selected' : '' }}>Inactivo
                                        </option>
                                        <option value="1" {{ $profesor->estado == 1 ? 'selected' : '' }}>Activo
                                        </option>
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="d-grid">
                                    <button class="btn btn-danger">Actualizar profesor</button>
                                </div>
                            </div>
                        </div>
                    </form>
